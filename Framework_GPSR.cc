...
main (int argc, char *argv[])
{
  ...
  MobilityHelper mobility; //TODO: replace with mobility model from SUMO
  ...
  mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (0, 5, 0, 5)));
  ...
  //TODO: Replace UDP server with emergency vehicle alert
  ...
  //Ipv4GlobalRoutingHelper::PopulateRoutingTables (); //TODO: Replace with Our protocol or GPSR

  Simulator::Stop (Seconds (20.0));

  phy.EnablePcap ("client", staDevices.Get(0));
  phy.EnablePcap ("server", staDevices.Get(nWifi-1));
